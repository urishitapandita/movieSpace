...
$sql = "SELECT * FROM friends WHERE user_two = '$user' AND is_friends ='0';";
                        ...
                        <div class="all-user">
                            <div class="user-container">
                                ...
                                <div class="content1">
                                    ...
                                    <button style="background-color: red;"><a href="partials/_decline.php?user1=<?php echo $user;?>&user2=<?php echo $username?>">Decline</a></button>
