...
<div class="profileReview">
	<div class="profileReviewContainer">
		...
		$sql = "SELECT * FROM `post_100` WHERE sno = $id;";
		...
		?>
					...
					<div class="profileCardImage">
						...
						<div class="profileCard">
							<h3><?php echo strtoupper($moviename); ?></h3>
		...
		<form class="comments" action="partials/addcomment.php?id=<?php echo $id; ?>" method="POST">
		...
		$sql1 = "SELECT * FROM comments WHERE comment_cat_id=$id;";
